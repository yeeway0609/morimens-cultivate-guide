const awakers = [
  ...
  },
  {
    ...
    "recommend_evolution": 1,
    "recommend_evolution_desc": "一啟關鍵，血肉隊有多需要胚胎玩過都僅，二段打擊也讓夫人能擔任切割手，降低承傷。<br>二啟穩定爆擊率，可惜是臨時，這部分比較容易用造物和命輪做補強，非必要。<br>三啟開場及觸發死抗可以加速胚胎，可以考慮和菲茵特<br>一起入隊。開局給胚胎融合也可以稍微降低小怪關卡的壓力。",
