const awakers = [
  {
    ...
    "recommend_teams": `[
      { "awaker_id": [1, 14, 15, 28], "awaker_position": ["輔助","護盾","生存","主C"], "team_desc": "很穩定常見的深海配置。<br><br>拉蒙娜覺醒後可以過牌、充能鑰令，開場可以快速拉出需要的覺醒卡，戰鬥中缺防禦或觸手就找美的憐憫，缺輸出就找深淵號令。<br><br>除了缺乏爆發傷害，這隊平推關卡非常好用，但越級超過10等會比較吃力。" },
      { "awaker_id": [1, 29, 27, 999], "awaker_position": ["輔助", "主C", "輔助", "任意"], "team_desc": "拉蒙娜在這隊玩法跟上面是一樣的，唯一主力是達芙黛爾的斷頸一擊、配合卡茜亞的隔空取物可以把斷頸一擊從超維空間拉出來再打一發，只要牌順好、傷害夠，現版本越級最強組合。<br><br>值得一提的是這隊不太吃覺醒，一般只需考慮覺醒拉蒙娜跟達芙黛爾。" }
    ]`
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "type": "傷害型",
    "position": "輸出",
    "intro": "官方定位是輸出型，現階段血肉輸出之一。<br>傷害手段是多段輸出，需要有力量類輔助，依賴多段傷害及覺醒堆疊大量臨時力量以打出高額傷害，此外也有回血和優秀的胚胎融合的能力。在團隊可以作為主輸出，也可以勝任副輸出的角色。<br><br>技能建議優先提升珠玉之卵、打擊、覺醒、狂氣爆發。<br><br>相比希洛和尤烏哈希，索蕾爾一啟就是傷害完全體，目前傷害上限最高的是三啟尤烏哈希，小怪穩定度最高的是三啟希洛，傷害面各有勝場。<br><br>但是索蕾爾自己可以產胚胎，血肉的強度，在於生胎的速度，索蕾爾綜合強度還是大於常駐角色的。",
    "recommend_evolution": 1,
    "recommend_evolution_desc": "一啟關鍵，血肉隊有多需要胚胎玩過都僅，二段打擊也讓夫人能擔任切割手，降低承傷。<br><br>二啟穩定爆擊率，可惜是臨時，這部分比較容易用造物和命輪做補強，非必要。<br><br>三啟開場及觸發死抗可以加速胚胎，可以考慮和菲茵特一起入隊。開局給胚胎融合也可以稍微降低小怪關卡的壓力。",
    "rage_burst": "【無限吞噬：本次權欲輪舞的傷害次數+3。】<br>隨機造成6點傷害5次。回復5點生命。",
    "recommend_destiny_wheels_id": [65, 64, 45, 43],
    "recommend_destiny_wheels_desc": [
      "作為輸出使用<br>索蕾爾專武，以薔薇之名的三段傷害可以吃到力量加成，也可以吃到索蕾爾覺醒增加臨時力量，等於狂氣爆發常駐1個胚胎的特效（5+3次傷害，接近60%的增傷），但是在無限吞噬後邊際效應遞減。<br>假設一次吞了五個胚胎，增傷只剩下大約15%的效果。<br>也就是說在王關，藏品上限是比薔薇優秀的，但是薔薇能大幅增加清理小怪跟菁英的效率。",
      "作為輸出使用<br>擁有極致暴傷加成的命輪，擊殺敵人時還能提供些許黑印。若是暴擊率堆疊夠高，可選用暴傷加成的命輪來提升傷害。",
      "作為輸出使用<br>提高打擊卡牌傷害，生成打擊卡牌<br>對胚胎融合和狂氣回充都很有幫助",
      "作為副C使用<br>作為副C時配戴，可使打擊卡牌附加減攻效果。"
    ],
